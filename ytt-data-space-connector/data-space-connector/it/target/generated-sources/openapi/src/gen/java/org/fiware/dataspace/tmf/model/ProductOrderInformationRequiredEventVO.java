...
import org.fiware.dataspace.tmf.model.ProductOrderInformationRequiredEventPayloadVO;
...
@JsonTypeName("ProductOrderInformationRequiredEvent")
...
public class ProductOrderInformationRequiredEventVO   {
   ...
   **/
  public ProductOrderInformationRequiredEventVO eventId(String eventId) {
   ...
   **/
  public ProductOrderInformationRequiredEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOrderInformationRequiredEventVO eventType(String eventType) {
   ...
   **/
  public ProductOrderInformationRequiredEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOrderInformationRequiredEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOrderInformationRequiredEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOrderInformationRequiredEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOrderInformationRequiredEventVO priority(String priority) {
   ...
   **/
  public ProductOrderInformationRequiredEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public ProductOrderInformationRequiredEventVO fieldPath(String fieldPath) {
  ...
  /**
   **/
  public ProductOrderInformationRequiredEventVO event(ProductOrderInformationRequiredEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOrderInformationRequiredEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOrderInformationRequiredEventPayloadVO event) {
    this.event = event;
  }
