...
import org.fiware.dataspace.tmf.model.ProductOfferingPriceDeleteEventPayloadVO;
...
public class ProductOfferingPriceDeleteEventVO   {
  ...
  /**
   **/
  public ProductOfferingPriceDeleteEventVO event(ProductOfferingPriceDeleteEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOfferingPriceDeleteEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOfferingPriceDeleteEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public ProductOfferingPriceDeleteEventVO eventId(String eventId) {
   ...
   **/
  public ProductOfferingPriceDeleteEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOfferingPriceDeleteEventVO eventType(String eventType) {
   ...
   **/
  public ProductOfferingPriceDeleteEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOfferingPriceDeleteEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceDeleteEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceDeleteEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOfferingPriceDeleteEventVO priority(String priority) {
   ...
   **/
  public ProductOfferingPriceDeleteEventVO timeOcurred(Date timeOcurred) {
