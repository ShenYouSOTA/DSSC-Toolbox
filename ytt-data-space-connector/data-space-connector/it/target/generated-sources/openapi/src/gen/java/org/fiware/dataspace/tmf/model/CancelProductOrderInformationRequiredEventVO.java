...
import org.fiware.dataspace.tmf.model.CancelProductOrderInformationRequiredEventPayloadVO;
...
@JsonTypeName("CancelProductOrderInformationRequiredEvent")
...
public class CancelProductOrderInformationRequiredEventVO   {
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO eventId(String eventId) {
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO eventTime(Date eventTime) {
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO eventType(String eventType) {
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO correlationId(String correlationId) {
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO description(String description) {
   ...
   * A priority.
   **/
  public CancelProductOrderInformationRequiredEventVO priority(String priority) {
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public CancelProductOrderInformationRequiredEventVO fieldPath(String fieldPath) {
  ...
  /**
   **/
  public CancelProductOrderInformationRequiredEventVO event(CancelProductOrderInformationRequiredEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public CancelProductOrderInformationRequiredEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(CancelProductOrderInformationRequiredEventPayloadVO event) {
    this.event = event;
  }
