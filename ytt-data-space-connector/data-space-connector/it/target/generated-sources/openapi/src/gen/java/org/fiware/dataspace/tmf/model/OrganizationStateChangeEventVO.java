...
import org.fiware.dataspace.tmf.model.OrganizationStateChangeEventPayloadVO;
...
@JsonTypeName("OrganizationStateChangeEvent")
...
public class OrganizationStateChangeEventVO   {
   ...
   **/
  public OrganizationStateChangeEventVO eventId(String eventId) {
   ...
   **/
  public OrganizationStateChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public OrganizationStateChangeEventVO description(String description) {
   ...
   **/
  public OrganizationStateChangeEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public OrganizationStateChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public OrganizationStateChangeEventVO eventType(String eventType) {
   ...
   **/
  public OrganizationStateChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * A priority.
   **/
  public OrganizationStateChangeEventVO priority(String priority) {
   ...
   **/
  public OrganizationStateChangeEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public OrganizationStateChangeEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public OrganizationStateChangeEventVO correlationId(String correlationId) {
  ...
  /**
   **/
  public OrganizationStateChangeEventVO event(OrganizationStateChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public OrganizationStateChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(OrganizationStateChangeEventPayloadVO event) {
    this.event = event;
  }
