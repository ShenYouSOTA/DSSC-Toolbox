...
public class ProductOfferingVO   {
   ...
   **/
  public ProductOfferingVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductOfferingVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductOfferingVO description(String description) {
   ...
   **/
  public ProductOfferingVO isBundle(Boolean isBundle) {
   ...
   **/
  public ProductOfferingVO isSellable(Boolean isSellable) {
   ...
   **/
  public ProductOfferingVO lastUpdate(Date lastUpdate) {
   ...
   **/
  public ProductOfferingVO lifecycleStatus(String lifecycleStatus) {
   ...
   **/
  public ProductOfferingVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ProductOfferingVO statusReason(String statusReason) {
   ...
   **/
  public ProductOfferingVO version(String version) {
   ...
   **/
  public ProductOfferingVO agreement(List<@Valid AgreementRefVO> agreement) {
  ...
  public ProductOfferingVO removeAgreementItem(AgreementRefVO agreementItem) {
   ...
   **/
  public ProductOfferingVO attachment(List<@Valid AttachmentRefOrValueVO> attachment) {
  ...
  public ProductOfferingVO removeAttachmentItem(AttachmentRefOrValueVO attachmentItem) {
   ...
   **/
  public ProductOfferingVO bundledProductOffering(List<@Valid BundledProductOfferingVO> bundledProductOffering) {
  ...
  public ProductOfferingVO removeBundledProductOfferingItem(BundledProductOfferingVO bundledProductOfferingItem) {
   ...
   **/
  public ProductOfferingVO category(List<@Valid CategoryRefVO> category) {
  ...
  public ProductOfferingVO removeCategoryItem(CategoryRefVO categoryItem) {
   ...
   **/
  public ProductOfferingVO channel(List<@Valid ChannelRefVO> channel) {
  ...
  public ProductOfferingVO removeChannelItem(ChannelRefVO channelItem) {
   ...
   **/
  public ProductOfferingVO marketSegment(List<@Valid MarketSegmentRefVO> marketSegment) {
  ...
  public ProductOfferingVO removeMarketSegmentItem(MarketSegmentRefVO marketSegmentItem) {
   ...
   **/
  public ProductOfferingVO place(List<@Valid PlaceRefVO> place) {
    this.place = place;
    return this;
  }
  ...
  public ProductOfferingVO removePlaceItem(PlaceRefVO placeItem) {
   ...
   **/
  public ProductOfferingVO prodSpecCharValueUse(List<@Valid ProductSpecificationCharacteristicValueUseVO> prodSpecCharValueUse) {
  ...
  public ProductOfferingVO removeProdSpecCharValueUseItem(ProductSpecificationCharacteristicValueUseVO prodSpecCharValueUseItem) {
   ...
   **/
  public ProductOfferingVO productOfferingPrice(List<@Valid ProductOfferingPriceRefOrValueVO> productOfferingPrice) {
  ...
  public ProductOfferingVO removeProductOfferingPriceItem(ProductOfferingPriceRefOrValueVO productOfferingPriceItem) {
   ...
   **/
  public ProductOfferingVO productOfferingRelationship(List<@Valid ProductOfferingRelationshipVO> productOfferingRelationship) {
  ...
  public ProductOfferingVO removeProductOfferingRelationshipItem(ProductOfferingRelationshipVO productOfferingRelationshipItem) {
   ...
   **/
  public ProductOfferingVO productOfferingTerm(List<@Valid ProductOfferingTermVO> productOfferingTerm) {
  ...
  public ProductOfferingVO removeProductOfferingTermItem(ProductOfferingTermVO productOfferingTermItem) {
  ...
  /**
   **/
  public ProductOfferingVO productSpecification(ProductSpecificationRefVO productSpecification) {
  ...
  /**
   **/
  public ProductOfferingVO resourceCandidate(ResourceCandidateRefVO resourceCandidate) {
  ...
  /**
   **/
  public ProductOfferingVO serviceCandidate(ServiceCandidateRefVO serviceCandidate) {
  ...
  /**
   **/
  public ProductOfferingVO serviceLevelAgreement(SLARefVO serviceLevelAgreement) {
  ...
  /**
   **/
  public ProductOfferingVO validFor(TimePeriodVO validFor) {
   ...
   **/
  public ProductOfferingVO atBaseType(String atBaseType) {
   ...
   **/
  public ProductOfferingVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ProductOfferingVO atType(String atType) {
    this.atType = atType;
    return this;
  }
