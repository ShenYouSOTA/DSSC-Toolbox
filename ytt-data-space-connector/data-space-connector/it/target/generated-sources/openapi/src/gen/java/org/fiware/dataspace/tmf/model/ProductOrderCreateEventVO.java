...
import org.fiware.dataspace.tmf.model.ProductOrderCreateEventPayloadVO;
...
@JsonTypeName("ProductOrderCreateEvent")
...
public class ProductOrderCreateEventVO   {
   ...
   **/
  public ProductOrderCreateEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductOrderCreateEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductOrderCreateEventVO eventId(String eventId) {
   ...
   **/
  public ProductOrderCreateEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOrderCreateEventVO eventType(String eventType) {
   ...
   **/
  public ProductOrderCreateEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOrderCreateEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOrderCreateEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOrderCreateEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOrderCreateEventVO priority(String priority) {
   ...
   **/
  public ProductOrderCreateEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public ProductOrderCreateEventVO event(ProductOrderCreateEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOrderCreateEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOrderCreateEventPayloadVO event) {
    this.event = event;
  }
