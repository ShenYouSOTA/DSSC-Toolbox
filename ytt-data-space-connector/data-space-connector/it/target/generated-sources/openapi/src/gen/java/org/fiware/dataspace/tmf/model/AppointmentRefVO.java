...
public class AppointmentRefVO   {
   ...
   **/
  public AppointmentRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public AppointmentRefVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public AppointmentRefVO description(String description) {
   ...
   **/
  public AppointmentRefVO atBaseType(String atBaseType) {
   ...
   **/
  public AppointmentRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public AppointmentRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public AppointmentRefVO atReferredType(String atReferredType) {
