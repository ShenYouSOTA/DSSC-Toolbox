...
public class POPChargeVO   {
   ...
   * unique identifier
   **/
  public POPChargeVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public POPChargeVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public POPChargeVO description(String description) {
   ...
   **/
  public POPChargeVO lastUpdate(Date lastUpdate) {
   ...
   **/
  public POPChargeVO lifecycleStatus(String lifecycleStatus) {
   ...
   **/
  public POPChargeVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public POPChargeVO priceType(String priceType) {
   ...
   **/
  public POPChargeVO recurringChargePeriod(String recurringChargePeriod) {
   ...
   **/
  public POPChargeVO recurringChargePeriodLength(Integer recurringChargePeriodLength) {
   ...
   **/
  public POPChargeVO version(String version) {
   ...
   **/
  public POPChargeVO constraint(List<@Valid ConstraintRefVO> constraint) {
  ...
  public POPChargeVO removeConstraintItem(ConstraintRefVO constraintItem) {
  ...
  /**
   **/
  public POPChargeVO price(ProductPriceValueVO price) {
    this.price = price;
    return this;
  }
  ...
  /**
   **/
  public POPChargeVO priceAlteration(List<@Valid POPAlterationVO> priceAlteration) {
  ...
  public POPChargeVO removePriceAlterationItem(POPAlterationVO priceAlterationItem) {
  ...
  /**
   **/
  public POPChargeVO unitOfMeasure(QuantityVO unitOfMeasure) {
  ...
  /**
   **/
  public POPChargeVO validFor(TimePeriodVO validFor) {
   ...
   **/
  public POPChargeVO atBaseType(String atBaseType) {
   ...
   **/
  public POPChargeVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public POPChargeVO atType(String atType) {
    this.atType = atType;
    return this;
  }
