...
@JsonTypeName("ServiceCandidateDeleteEventPayload")
...
public class ServiceCandidateDeleteEventPayloadVO   {
  private ServiceCandidateVO serviceCandidate;

  /**
   **/
  public ServiceCandidateDeleteEventPayloadVO serviceCandidate(ServiceCandidateVO serviceCandidate) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceCandidateDeleteEventPayloadVO serviceCandidateDeleteEventPayload = (ServiceCandidateDeleteEventPayloadVO) o;
  ...
  public String toString() {
    ...
    sb.append("class ServiceCandidateDeleteEventPayloadVO {\n");
