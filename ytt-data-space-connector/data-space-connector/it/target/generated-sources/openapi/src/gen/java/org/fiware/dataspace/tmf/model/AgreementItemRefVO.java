...
public class AgreementItemRefVO   {
   ...
   **/
  public AgreementItemRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public AgreementItemRefVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public AgreementItemRefVO agreementItemId(String agreementItemId) {
   ...
   **/
  public AgreementItemRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public AgreementItemRefVO atBaseType(String atBaseType) {
   ...
   **/
  public AgreementItemRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public AgreementItemRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public AgreementItemRefVO atReferredType(String atReferredType) {
