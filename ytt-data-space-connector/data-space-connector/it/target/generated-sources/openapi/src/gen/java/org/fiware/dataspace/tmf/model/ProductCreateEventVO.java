...
import org.fiware.dataspace.tmf.model.ProductCreateEventPayloadVO;
...
@JsonTypeName("ProductCreateEvent")
...
public class ProductCreateEventVO   {
   ...
   **/
  public ProductCreateEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductCreateEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductCreateEventVO eventId(String eventId) {
   ...
   **/
  public ProductCreateEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductCreateEventVO eventType(String eventType) {
   ...
   **/
  public ProductCreateEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductCreateEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductCreateEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductCreateEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductCreateEventVO priority(String priority) {
   ...
   **/
  public ProductCreateEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public ProductCreateEventVO event(ProductCreateEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductCreateEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductCreateEventPayloadVO event) {
    this.event = event;
  }
