...
public class ProductOfferingRefVO   {
   ...
   **/
  public ProductOfferingRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductOfferingRefVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductOfferingRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ProductOfferingRefVO atBaseType(String atBaseType) {
   ...
   **/
  public ProductOfferingRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ProductOfferingRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public ProductOfferingRefVO atReferredType(String atReferredType) {
