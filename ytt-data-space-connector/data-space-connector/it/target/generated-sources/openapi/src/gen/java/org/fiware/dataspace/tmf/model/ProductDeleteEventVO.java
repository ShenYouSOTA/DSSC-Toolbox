...
import org.fiware.dataspace.tmf.model.ProductDeleteEventPayloadVO;
...
@JsonTypeName("ProductDeleteEvent")
...
public class ProductDeleteEventVO   {
   ...
   **/
  public ProductDeleteEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductDeleteEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductDeleteEventVO eventId(String eventId) {
   ...
   **/
  public ProductDeleteEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductDeleteEventVO eventType(String eventType) {
   ...
   **/
  public ProductDeleteEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductDeleteEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductDeleteEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductDeleteEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductDeleteEventVO priority(String priority) {
   ...
   **/
  public ProductDeleteEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public ProductDeleteEventVO event(ProductDeleteEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductDeleteEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductDeleteEventPayloadVO event) {
    this.event = event;
  }
