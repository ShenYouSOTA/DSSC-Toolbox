...
public class OrderTermVO   {
   ...
   **/
  public OrderTermVO description(String description) {
   ...
   **/
  public OrderTermVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   **/
  public OrderTermVO duration(QuantityVO duration) {
  ...
  @Valid public QuantityVO getDuration() {
    return duration;
  }

  @JsonProperty("duration")
  public void setDuration(QuantityVO duration) {
    this.duration = duration;
  }
   ...
   **/
  public OrderTermVO atBaseType(String atBaseType) {
   ...
   **/
  public OrderTermVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public OrderTermVO atType(String atType) {
    this.atType = atType;
    return this;
  }
