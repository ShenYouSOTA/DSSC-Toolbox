...
import org.fiware.dataspace.tmf.model.IndividualAttributeValueChangeEventPayloadVO;
...
@JsonTypeName("IndividualAttributeValueChangeEvent")
...
public class IndividualAttributeValueChangeEventVO   {
   ...
   **/
  public IndividualAttributeValueChangeEventVO eventId(String eventId) {
   ...
   **/
  public IndividualAttributeValueChangeEventVO fieldPath(String fieldPath) {
   ...
   **/
  public IndividualAttributeValueChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public IndividualAttributeValueChangeEventVO description(String description) {
   ...
   **/
  public IndividualAttributeValueChangeEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public IndividualAttributeValueChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public IndividualAttributeValueChangeEventVO eventType(String eventType) {
   ...
   **/
  public IndividualAttributeValueChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * A priority.
   **/
  public IndividualAttributeValueChangeEventVO priority(String priority) {
   ...
   **/
  public IndividualAttributeValueChangeEventVO correlationId(String correlationId) {
  ...
  /**
   **/
  public IndividualAttributeValueChangeEventVO event(IndividualAttributeValueChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public IndividualAttributeValueChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(IndividualAttributeValueChangeEventPayloadVO event) {
    this.event = event;
  }
