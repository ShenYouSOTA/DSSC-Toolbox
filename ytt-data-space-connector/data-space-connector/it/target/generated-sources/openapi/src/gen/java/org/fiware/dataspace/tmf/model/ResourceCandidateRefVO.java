...
public class ResourceCandidateRefVO   {
   ...
   * unique identifier
   **/
  public ResourceCandidateRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public ResourceCandidateRefVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ResourceCandidateRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ResourceCandidateRefVO version(String version) {
   ...
   **/
  public ResourceCandidateRefVO atBaseType(String atBaseType) {
   ...
   **/
  public ResourceCandidateRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ResourceCandidateRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public ResourceCandidateRefVO atReferredType(String atReferredType) {
