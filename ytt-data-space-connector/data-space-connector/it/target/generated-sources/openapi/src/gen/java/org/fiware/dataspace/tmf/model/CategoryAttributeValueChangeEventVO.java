...
import org.fiware.dataspace.tmf.model.CategoryAttributeValueChangeEventPayloadVO;
...
public class CategoryAttributeValueChangeEventVO   {
   ...
   **/
  public CategoryAttributeValueChangeEventVO eventId(String eventId) {
   ...
   **/
  public CategoryAttributeValueChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public CategoryAttributeValueChangeEventVO eventType(String eventType) {
   ...
   **/
  public CategoryAttributeValueChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public CategoryAttributeValueChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public CategoryAttributeValueChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public CategoryAttributeValueChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public CategoryAttributeValueChangeEventVO priority(String priority) {
   ...
   **/
  public CategoryAttributeValueChangeEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public CategoryAttributeValueChangeEventVO fieldPath(String fieldPath) {
  ...
  /**
   **/
  public CategoryAttributeValueChangeEventVO event(CategoryAttributeValueChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public CategoryAttributeValueChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(CategoryAttributeValueChangeEventPayloadVO event) {
    this.event = event;
  }
