...
import org.fiware.dataspace.tmf.model.ProductStateChangeEventPayloadVO;
...
@JsonTypeName("ProductStateChangeEvent")
...
public class ProductStateChangeEventVO   {
   ...
   **/
  public ProductStateChangeEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductStateChangeEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductStateChangeEventVO eventId(String eventId) {
   ...
   **/
  public ProductStateChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductStateChangeEventVO eventType(String eventType) {
   ...
   **/
  public ProductStateChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductStateChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductStateChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductStateChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductStateChangeEventVO priority(String priority) {
   ...
   **/
  public ProductStateChangeEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public ProductStateChangeEventVO event(ProductStateChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductStateChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductStateChangeEventPayloadVO event) {
    this.event = event;
  }
