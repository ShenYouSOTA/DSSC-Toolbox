...
public class ResourceSpecificationRefVO   {
   ...
   * unique identifier
   **/
  public ResourceSpecificationRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public ResourceSpecificationRefVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ResourceSpecificationRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ResourceSpecificationRefVO version(String version) {
   ...
   **/
  public ResourceSpecificationRefVO atBaseType(String atBaseType) {
   ...
   **/
  public ResourceSpecificationRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ResourceSpecificationRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public ResourceSpecificationRefVO atReferredType(String atReferredType) {
