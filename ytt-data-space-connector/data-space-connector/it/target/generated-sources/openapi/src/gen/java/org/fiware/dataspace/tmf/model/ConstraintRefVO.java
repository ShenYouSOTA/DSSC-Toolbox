...
public class ConstraintRefVO   {
   ...
   * unique identifier
   **/
  public ConstraintRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public ConstraintRefVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ConstraintRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   * constraint version
   **/
  public ConstraintRefVO version(String version) {
   ...
   **/
  public ConstraintRefVO atBaseType(String atBaseType) {
   ...
   **/
  public ConstraintRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ConstraintRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public ConstraintRefVO atReferredType(String atReferredType) {
