...
import org.fiware.dataspace.tmf.model.ProductOrderAttributeValueChangeEventPayloadVO;
...
@JsonTypeName("ProductOrderAttributeValueChangeEvent")
...
public class ProductOrderAttributeValueChangeEventVO   {
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO eventId(String eventId) {
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO eventType(String eventType) {
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOrderAttributeValueChangeEventVO priority(String priority) {
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public ProductOrderAttributeValueChangeEventVO fieldPath(String fieldPath) {
  ...
  /**
   **/
  public ProductOrderAttributeValueChangeEventVO event(ProductOrderAttributeValueChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOrderAttributeValueChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOrderAttributeValueChangeEventPayloadVO event) {
    this.event = event;
  }
