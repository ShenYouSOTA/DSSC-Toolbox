...
import org.fiware.dataspace.tmf.model.ProductOfferingAttributeValueChangeEventPayloadVO;
...
public class ProductOfferingAttributeValueChangeEventVO   {
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO eventId(String eventId) {
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO eventType(String eventType) {
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOfferingAttributeValueChangeEventVO priority(String priority) {
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public ProductOfferingAttributeValueChangeEventVO fieldPath(String fieldPath) {
  ...
  /**
   **/
  public ProductOfferingAttributeValueChangeEventVO event(ProductOfferingAttributeValueChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOfferingAttributeValueChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOfferingAttributeValueChangeEventPayloadVO event) {
    this.event = event;
  }
