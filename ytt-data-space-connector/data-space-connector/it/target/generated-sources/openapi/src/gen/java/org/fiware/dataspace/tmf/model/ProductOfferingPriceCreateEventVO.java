...
import org.fiware.dataspace.tmf.model.ProductOfferingPriceCreateEventPayloadVO;
...
public class ProductOfferingPriceCreateEventVO   {
  ...
  /**
   **/
  public ProductOfferingPriceCreateEventVO event(ProductOfferingPriceCreateEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOfferingPriceCreateEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOfferingPriceCreateEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public ProductOfferingPriceCreateEventVO eventId(String eventId) {
   ...
   **/
  public ProductOfferingPriceCreateEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOfferingPriceCreateEventVO eventType(String eventType) {
   ...
   **/
  public ProductOfferingPriceCreateEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOfferingPriceCreateEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceCreateEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceCreateEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOfferingPriceCreateEventVO priority(String priority) {
   ...
   **/
  public ProductOfferingPriceCreateEventVO timeOcurred(Date timeOcurred) {
