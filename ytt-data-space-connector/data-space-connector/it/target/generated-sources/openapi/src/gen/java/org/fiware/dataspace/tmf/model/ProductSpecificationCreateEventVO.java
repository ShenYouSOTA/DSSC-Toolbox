...
import org.fiware.dataspace.tmf.model.ProductSpecificationCreateEventPayloadVO;
...
public class ProductSpecificationCreateEventVO   {
  ...
  /**
   **/
  public ProductSpecificationCreateEventVO event(ProductSpecificationCreateEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductSpecificationCreateEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductSpecificationCreateEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public ProductSpecificationCreateEventVO eventId(String eventId) {
   ...
   **/
  public ProductSpecificationCreateEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductSpecificationCreateEventVO eventType(String eventType) {
   ...
   **/
  public ProductSpecificationCreateEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductSpecificationCreateEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductSpecificationCreateEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductSpecificationCreateEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductSpecificationCreateEventVO priority(String priority) {
   ...
   **/
  public ProductSpecificationCreateEventVO timeOcurred(Date timeOcurred) {
