...
import org.fiware.dataspace.tmf.model.ProductOrderStateChangeEventPayloadVO;
...
@JsonTypeName("ProductOrderStateChangeEvent")
...
public class ProductOrderStateChangeEventVO   {
   ...
   **/
  public ProductOrderStateChangeEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductOrderStateChangeEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductOrderStateChangeEventVO eventId(String eventId) {
   ...
   **/
  public ProductOrderStateChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOrderStateChangeEventVO eventType(String eventType) {
   ...
   **/
  public ProductOrderStateChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOrderStateChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOrderStateChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOrderStateChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOrderStateChangeEventVO priority(String priority) {
   ...
   **/
  public ProductOrderStateChangeEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public ProductOrderStateChangeEventVO event(ProductOrderStateChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOrderStateChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOrderStateChangeEventPayloadVO event) {
    this.event = event;
  }
