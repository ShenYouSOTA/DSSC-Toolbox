...
import org.fiware.dataspace.tmf.model.ProductSpecificationDeleteEventPayloadVO;
...
public class ProductSpecificationDeleteEventVO   {
  ...
  /**
   **/
  public ProductSpecificationDeleteEventVO event(ProductSpecificationDeleteEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductSpecificationDeleteEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductSpecificationDeleteEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public ProductSpecificationDeleteEventVO eventId(String eventId) {
   ...
   **/
  public ProductSpecificationDeleteEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductSpecificationDeleteEventVO eventType(String eventType) {
   ...
   **/
  public ProductSpecificationDeleteEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductSpecificationDeleteEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductSpecificationDeleteEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductSpecificationDeleteEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductSpecificationDeleteEventVO priority(String priority) {
   ...
   **/
  public ProductSpecificationDeleteEventVO timeOcurred(Date timeOcurred) {
