...
import org.fiware.dataspace.tmf.model.CancelProductOrderStateChangeEventPayloadVO;
...
@JsonTypeName("CancelProductOrderStateChangeEvent")
...
public class CancelProductOrderStateChangeEventVO   {
   ...
   **/
  public CancelProductOrderStateChangeEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public CancelProductOrderStateChangeEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public CancelProductOrderStateChangeEventVO eventId(String eventId) {
   ...
   **/
  public CancelProductOrderStateChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public CancelProductOrderStateChangeEventVO eventType(String eventType) {
   ...
   **/
  public CancelProductOrderStateChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public CancelProductOrderStateChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public CancelProductOrderStateChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public CancelProductOrderStateChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public CancelProductOrderStateChangeEventVO priority(String priority) {
   ...
   **/
  public CancelProductOrderStateChangeEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public CancelProductOrderStateChangeEventVO event(CancelProductOrderStateChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public CancelProductOrderStateChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(CancelProductOrderStateChangeEventPayloadVO event) {
    this.event = event;
  }
