...
public class CategoryRefVO   {
   ...
   * unique identifier
   **/
  public CategoryRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public CategoryRefVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public CategoryRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   * Category version
   **/
  public CategoryRefVO version(String version) {
   ...
   **/
  public CategoryRefVO atBaseType(String atBaseType) {
   ...
   **/
  public CategoryRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public CategoryRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public CategoryRefVO atReferredType(String atReferredType) {
