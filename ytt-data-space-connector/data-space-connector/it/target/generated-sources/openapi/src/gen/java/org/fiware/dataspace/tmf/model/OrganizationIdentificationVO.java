...
@JsonTypeName("OrganizationIdentification")
...
public class OrganizationIdentificationVO   {
   ...
   * Identifier
   **/
  public OrganizationIdentificationVO identificationId(String identificationId) {
   ...
   **/
  public OrganizationIdentificationVO identificationType(String identificationType) {
   ...
   **/
  public OrganizationIdentificationVO issuingAuthority(String issuingAuthority) {
   ...
   **/
  public OrganizationIdentificationVO issuingDate(Date issuingDate) {
  ...
  /**
   **/
  public OrganizationIdentificationVO attachment(AttachmentRefOrValueVO attachment) {
  ...
  /**
   **/
  public OrganizationIdentificationVO validFor(TimePeriodVO validFor) {
   ...
   **/
  public OrganizationIdentificationVO atBaseType(String atBaseType) {
   ...
   **/
  public OrganizationIdentificationVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public OrganizationIdentificationVO atType(String atType) {
    this.atType = atType;
    return this;
  }
