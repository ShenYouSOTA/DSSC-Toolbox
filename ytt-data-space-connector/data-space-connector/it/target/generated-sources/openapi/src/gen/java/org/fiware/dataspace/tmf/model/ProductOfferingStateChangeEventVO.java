...
import org.fiware.dataspace.tmf.model.ProductOfferingStateChangeEventPayloadVO;
...
public class ProductOfferingStateChangeEventVO   {
  ...
  /**
   **/
  public ProductOfferingStateChangeEventVO event(ProductOfferingStateChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOfferingStateChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOfferingStateChangeEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public ProductOfferingStateChangeEventVO eventId(String eventId) {
   ...
   **/
  public ProductOfferingStateChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOfferingStateChangeEventVO eventType(String eventType) {
   ...
   **/
  public ProductOfferingStateChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOfferingStateChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOfferingStateChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOfferingStateChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOfferingStateChangeEventVO priority(String priority) {
   ...
   **/
  public ProductOfferingStateChangeEventVO timeOcurred(Date timeOcurred) {
