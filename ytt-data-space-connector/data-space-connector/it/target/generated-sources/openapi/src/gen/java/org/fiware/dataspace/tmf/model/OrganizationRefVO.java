...
public class OrganizationRefVO   {
   ...
   **/
  public OrganizationRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public OrganizationRefVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public OrganizationRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public OrganizationRefVO atBaseType(String atBaseType) {
   ...
   **/
  public OrganizationRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public OrganizationRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public OrganizationRefVO atReferredType(String atReferredType) {
