...
public class RelatedChannelVO   {
   ...
   **/
  public RelatedChannelVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public RelatedChannelVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   * Name of the channel.
   **/
  public RelatedChannelVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public RelatedChannelVO role(String role) {
    this.role = role;
    return this;
  }
   ...
   **/
  public RelatedChannelVO atBaseType(String atBaseType) {
   ...
   **/
  public RelatedChannelVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public RelatedChannelVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public RelatedChannelVO atReferredType(String atReferredType) {
