...
@JsonTypeName("ServiceCatalogDeleteEventPayload")
...
public class ServiceCatalogDeleteEventPayloadVO   {
  private ServiceCatalogVO serviceCatalog;

  /**
   **/
  public ServiceCatalogDeleteEventPayloadVO serviceCatalog(ServiceCatalogVO serviceCatalog) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceCatalogDeleteEventPayloadVO serviceCatalogDeleteEventPayload = (ServiceCatalogDeleteEventPayloadVO) o;
  ...
  public String toString() {
    ...
    sb.append("class ServiceCatalogDeleteEventPayloadVO {\n");
