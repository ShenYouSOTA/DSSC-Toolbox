...
import org.fiware.dataspace.tmf.model.ProductOrderDeleteEventPayloadVO;
...
@JsonTypeName("ProductOrderDeleteEvent")
...
public class ProductOrderDeleteEventVO   {
   ...
   **/
  public ProductOrderDeleteEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductOrderDeleteEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductOrderDeleteEventVO eventId(String eventId) {
   ...
   **/
  public ProductOrderDeleteEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOrderDeleteEventVO eventType(String eventType) {
   ...
   **/
  public ProductOrderDeleteEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOrderDeleteEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOrderDeleteEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOrderDeleteEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOrderDeleteEventVO priority(String priority) {
   ...
   **/
  public ProductOrderDeleteEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public ProductOrderDeleteEventVO event(ProductOrderDeleteEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOrderDeleteEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOrderDeleteEventPayloadVO event) {
    this.event = event;
  }
