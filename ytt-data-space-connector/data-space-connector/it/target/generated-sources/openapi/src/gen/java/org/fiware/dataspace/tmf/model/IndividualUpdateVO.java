...
public class IndividualUpdateVO   {
   ...
   * e.g. Baron, Graf, Earl,…
   **/
  public IndividualUpdateVO aristocraticTitle(String aristocraticTitle) {
   ...
   * Birth date
   **/
  public IndividualUpdateVO birthDate(Date birthDate) {
   ...
   **/
  public IndividualUpdateVO countryOfBirth(String countryOfBirth) {
   ...
   * Date of death
   **/
  public IndividualUpdateVO deathDate(Date deathDate) {
   ...
   **/
  public IndividualUpdateVO familyName(String familyName) {
   ...
   * Family name prefix
   **/
  public IndividualUpdateVO familyNamePrefix(String familyNamePrefix) {
   ...
   **/
  public IndividualUpdateVO formattedName(String formattedName) {
   ...
   **/
  public IndividualUpdateVO fullName(String fullName) {
   ...
   * Gender
   **/
  public IndividualUpdateVO gender(String gender) {
    this.gender = gender;
    return this;
  }
   ...
   **/
  public IndividualUpdateVO generation(String generation) {
   ...
   **/
  public IndividualUpdateVO givenName(String givenName) {
   ...
   **/
  public IndividualUpdateVO legalName(String legalName) {
   ...
   **/
  public IndividualUpdateVO location(String location) {
   ...
   **/
  public IndividualUpdateVO maritalStatus(String maritalStatus) {
   ...
   **/
  public IndividualUpdateVO middleName(String middleName) {
   ...
   * Nationality
   **/
  public IndividualUpdateVO nationality(String nationality) {
   ...
   **/
  public IndividualUpdateVO placeOfBirth(String placeOfBirth) {
   ...
   **/
  public IndividualUpdateVO preferredGivenName(String preferredGivenName) {
   ...
   **/
  public IndividualUpdateVO title(String title) {
    this.title = title;
    return this;
  }
  ...
  /**
   **/
  public IndividualUpdateVO contactMedium(List<@Valid ContactMediumVO> contactMedium) {
  ...
  public IndividualUpdateVO removeContactMediumItem(ContactMediumVO contactMediumItem) {
  ...
  /**
   **/
  public IndividualUpdateVO creditRating(List<@Valid PartyCreditProfileVO> creditRating) {
  ...
  public IndividualUpdateVO removeCreditRatingItem(PartyCreditProfileVO creditRatingItem) {
  ...
  /**
   **/
  public IndividualUpdateVO disability(List<@Valid DisabilityVO> disability) {
  ...
  public IndividualUpdateVO removeDisabilityItem(DisabilityVO disabilityItem) {
  ...
  /**
   **/
  public IndividualUpdateVO externalReference(List<@Valid ExternalReferenceVO> externalReference) {
  ...
  public IndividualUpdateVO removeExternalReferenceItem(ExternalReferenceVO externalReferenceItem) {
  ...
  /**
   **/
  public IndividualUpdateVO individualIdentification(List<@Valid IndividualIdentificationVO> individualIdentification) {
  ...
  public IndividualUpdateVO removeIndividualIdentificationItem(IndividualIdentificationVO individualIdentificationItem) {
  ...
  /**
   **/
  public IndividualUpdateVO languageAbility(List<@Valid LanguageAbilityVO> languageAbility) {
  ...
  public IndividualUpdateVO removeLanguageAbilityItem(LanguageAbilityVO languageAbilityItem) {
  ...
  /**
   **/
  public IndividualUpdateVO otherName(List<@Valid OtherNameIndividualVO> otherName) {
  ...
  public IndividualUpdateVO removeOtherNameItem(OtherNameIndividualVO otherNameItem) {
  ...
  /**
   **/
  public IndividualUpdateVO partyCharacteristic(List<@Valid CharacteristicVO> partyCharacteristic) {
  ...
  public IndividualUpdateVO removePartyCharacteristicItem(CharacteristicVO partyCharacteristicItem) {
  ...
  /**
   **/
  public IndividualUpdateVO relatedParty(List<@Valid RelatedPartyVO> relatedParty) {
  ...
  public IndividualUpdateVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
  ...
  /**
   **/
  public IndividualUpdateVO skill(List<@Valid SkillVO> skill) {
    this.skill = skill;
    return this;
  }
  ...
  public IndividualUpdateVO removeSkillItem(SkillVO skillItem) {
  ...
  /**
   **/
  public IndividualUpdateVO status(IndividualStateTypeVO status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public IndividualUpdateVO taxExemptionCertificate(List<@Valid TaxExemptionCertificateVO> taxExemptionCertificate) {
  ...
  public IndividualUpdateVO removeTaxExemptionCertificateItem(TaxExemptionCertificateVO taxExemptionCertificateItem) {
   ...
   **/
  public IndividualUpdateVO atBaseType(String atBaseType) {
   ...
   **/
  public IndividualUpdateVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public IndividualUpdateVO atType(String atType) {
    this.atType = atType;
    return this;
  }
