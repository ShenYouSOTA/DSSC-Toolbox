...
import org.fiware.dataspace.tmf.model.ProductSpecificationAttributeValueChangeEventPayloadVO;
...
public class ProductSpecificationAttributeValueChangeEventVO   {
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO eventId(String eventId) {
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO eventType(String eventType) {
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductSpecificationAttributeValueChangeEventVO priority(String priority) {
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public ProductSpecificationAttributeValueChangeEventVO fieldPath(String fieldPath) {
  ...
  /**
   **/
  public ProductSpecificationAttributeValueChangeEventVO event(ProductSpecificationAttributeValueChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductSpecificationAttributeValueChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductSpecificationAttributeValueChangeEventPayloadVO event) {
    this.event = event;
  }
