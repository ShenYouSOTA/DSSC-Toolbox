...
import org.fiware.dataspace.tmf.model.ServiceCatalogChangeEventPayloadVO;
...
@JsonTypeName("ServiceCatalogChangeEvent")
...
public class ServiceCatalogChangeEventVO   {
  private ServiceCatalogChangeEventPayloadVO event;
  ...
  /**
   **/
  public ServiceCatalogChangeEventVO event(ServiceCatalogChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ServiceCatalogChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ServiceCatalogChangeEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public ServiceCatalogChangeEventVO eventId(String eventId) {
   ...
   **/
  public ServiceCatalogChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ServiceCatalogChangeEventVO eventType(String eventType) {
   ...
   **/
  public ServiceCatalogChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ServiceCatalogChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ServiceCatalogChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ServiceCatalogChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ServiceCatalogChangeEventVO priority(String priority) {
   ...
   **/
  public ServiceCatalogChangeEventVO timeOcurred(Date timeOcurred) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceCatalogChangeEventVO serviceCatalogChangeEvent = (ServiceCatalogChangeEventVO) o;
  ...
  public String toString() {
    ...
    sb.append("class ServiceCatalogChangeEventVO {\n");
