...
public class ServiceCandidateVO   {
  private String id;
  private URI href;
   ...
   * unique identifier
   **/
  public ServiceCandidateVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public ServiceCandidateVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ServiceCandidateVO description(String description) {
   ...
   **/
  public ServiceCandidateVO lastUpdate(Date lastUpdate) {
   ...
   **/
  public ServiceCandidateVO lifecycleStatus(String lifecycleStatus) {
   ...
   **/
  public ServiceCandidateVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ServiceCandidateVO version(String version) {
   ...
   **/
  public ServiceCandidateVO category(List<@Valid ServiceCategoryRefVO> category) {
  ...
  public ServiceCandidateVO addCategoryItem(ServiceCategoryRefVO categoryItem) {
  ...
  public ServiceCandidateVO removeCategoryItem(ServiceCategoryRefVO categoryItem) {
  ...
  /**
   **/
  public ServiceCandidateVO serviceSpecification(ServiceSpecificationRefVO serviceSpecification) {
  ...
  /**
   **/
  public ServiceCandidateVO validFor(TimePeriodVO validFor) {
   ...
   **/
  public ServiceCandidateVO atBaseType(String atBaseType) {
   ...
   **/
  public ServiceCandidateVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ServiceCandidateVO atType(String atType) {
    this.atType = atType;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ServiceCandidateVO serviceCandidate = (ServiceCandidateVO) o;
    return Objects.equals(this.id, serviceCandidate.id) &&
        ...
        Objects.equals(this.atBaseType, serviceCandidate.atBaseType) &&
        Objects.equals(this.atSchemaLocation, serviceCandidate.atSchemaLocation) &&
        Objects.equals(this.atType, serviceCandidate.atType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, href, description, lastUpdate, lifecycleStatus, name, version, category, serviceSpecification, validFor, atBaseType, atSchemaLocation, atType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ServiceCandidateVO {\n");
