...
@JsonTypeName("ProductOfferingQualificationRef")
...
public class ProductOfferingQualificationRefVO   {
   ...
   **/
  public ProductOfferingQualificationRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductOfferingQualificationRefVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductOfferingQualificationRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ProductOfferingQualificationRefVO atBaseType(String atBaseType) {
   ...
   **/
  public ProductOfferingQualificationRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ProductOfferingQualificationRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public ProductOfferingQualificationRefVO atReferredType(String atReferredType) {
