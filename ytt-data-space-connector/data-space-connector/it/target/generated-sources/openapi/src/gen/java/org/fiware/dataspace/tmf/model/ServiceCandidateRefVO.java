...
public class ServiceCandidateRefVO   {
   ...
   * unique identifier
   **/
  public ServiceCandidateRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public ServiceCandidateRefVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ServiceCandidateRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ServiceCandidateRefVO version(String version) {
   ...
   **/
  public ServiceCandidateRefVO atBaseType(String atBaseType) {
   ...
   **/
  public ServiceCandidateRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ServiceCandidateRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public ServiceCandidateRefVO atReferredType(String atReferredType) {
