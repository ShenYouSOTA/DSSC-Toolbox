...
public class ProductOfferingPriceUpdateVO   {
   ...
   **/
  public ProductOfferingPriceUpdateVO description(String description) {
   ...
   **/
  public ProductOfferingPriceUpdateVO isBundle(Boolean isBundle) {
   ...
   **/
  public ProductOfferingPriceUpdateVO lifecycleStatus(String lifecycleStatus) {
   ...
   **/
  public ProductOfferingPriceUpdateVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceUpdateVO percentage(Float percentage) {
   ...
   **/
  public ProductOfferingPriceUpdateVO priceType(String priceType) {
   ...
   **/
  public ProductOfferingPriceUpdateVO recurringChargePeriodLength(Integer recurringChargePeriodLength) {
   ...
   **/
  public ProductOfferingPriceUpdateVO recurringChargePeriodType(String recurringChargePeriodType) {
   ...
   **/
  public ProductOfferingPriceUpdateVO version(String version) {
   ...
   **/
  public ProductOfferingPriceUpdateVO bundledPopRelationship(List<@Valid BundledProductOfferingPriceRelationshipVO> bundledPopRelationship) {
  ...
  public ProductOfferingPriceUpdateVO removeBundledPopRelationshipItem(BundledProductOfferingPriceRelationshipVO bundledPopRelationshipItem) {
   ...
   **/
  public ProductOfferingPriceUpdateVO constraint(List<@Valid ConstraintRefVO> constraint) {
  ...
  public ProductOfferingPriceUpdateVO removeConstraintItem(ConstraintRefVO constraintItem) {
   ...
   **/
  public ProductOfferingPriceUpdateVO place(List<@Valid PlaceRefVO> place) {
    this.place = place;
    return this;
  }
  ...
  public ProductOfferingPriceUpdateVO removePlaceItem(PlaceRefVO placeItem) {
   ...
   **/
  public ProductOfferingPriceUpdateVO popRelationship(List<@Valid ProductOfferingPriceRelationshipVO> popRelationship) {
  ...
  public ProductOfferingPriceUpdateVO removePopRelationshipItem(ProductOfferingPriceRelationshipVO popRelationshipItem) {
  ...
  /**
   **/
  public ProductOfferingPriceUpdateVO price(MoneyVO price) {
    this.price = price;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceUpdateVO pricingLogicAlgorithm(List<@Valid PricingLogicAlgorithmVO> pricingLogicAlgorithm) {
  ...
  public ProductOfferingPriceUpdateVO removePricingLogicAlgorithmItem(PricingLogicAlgorithmVO pricingLogicAlgorithmItem) {
   ...
   **/
  public ProductOfferingPriceUpdateVO prodSpecCharValueUse(List<@Valid ProductSpecificationCharacteristicValueUseVO> prodSpecCharValueUse) {
  ...
  public ProductOfferingPriceUpdateVO removeProdSpecCharValueUseItem(ProductSpecificationCharacteristicValueUseVO prodSpecCharValueUseItem) {
   ...
   **/
  public ProductOfferingPriceUpdateVO productOfferingTerm(List<@Valid ProductOfferingTermVO> productOfferingTerm) {
  ...
  public ProductOfferingPriceUpdateVO removeProductOfferingTermItem(ProductOfferingTermVO productOfferingTermItem) {
   ...
   **/
  public ProductOfferingPriceUpdateVO tax(List<@Valid TaxItemVO> tax) {
    this.tax = tax;
    return this;
  }
  ...
  public ProductOfferingPriceUpdateVO removeTaxItem(TaxItemVO taxItem) {
  ...
  /**
   **/
  public ProductOfferingPriceUpdateVO unitOfMeasure(QuantityVO unitOfMeasure) {
  ...
  /**
   **/
  public ProductOfferingPriceUpdateVO validFor(TimePeriodVO validFor) {
   ...
   **/
  public ProductOfferingPriceUpdateVO atSchemaLocation(String atSchemaLocation) {
