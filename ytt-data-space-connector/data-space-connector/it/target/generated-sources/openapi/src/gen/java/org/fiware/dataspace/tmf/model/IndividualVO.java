...
public class IndividualVO   {
   ...
   **/
  public IndividualVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public IndividualVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   * e.g. Baron, Graf, Earl,…
   **/
  public IndividualVO aristocraticTitle(String aristocraticTitle) {
   ...
   * Birth date
   **/
  public IndividualVO birthDate(Date birthDate) {
   ...
   **/
  public IndividualVO countryOfBirth(String countryOfBirth) {
   ...
   * Date of death
   **/
  public IndividualVO deathDate(Date deathDate) {
   ...
   **/
  public IndividualVO familyName(String familyName) {
   ...
   * Family name prefix
   **/
  public IndividualVO familyNamePrefix(String familyNamePrefix) {
   ...
   **/
  public IndividualVO formattedName(String formattedName) {
   ...
   **/
  public IndividualVO fullName(String fullName) {
   ...
   * Gender
   **/
  public IndividualVO gender(String gender) {
    this.gender = gender;
    return this;
  }
   ...
   **/
  public IndividualVO generation(String generation) {
   ...
   **/
  public IndividualVO givenName(String givenName) {
   ...
   **/
  public IndividualVO legalName(String legalName) {
   ...
   **/
  public IndividualVO location(String location) {
   ...
   **/
  public IndividualVO maritalStatus(String maritalStatus) {
   ...
   **/
  public IndividualVO middleName(String middleName) {
   ...
   * Nationality
   **/
  public IndividualVO nationality(String nationality) {
   ...
   **/
  public IndividualVO placeOfBirth(String placeOfBirth) {
   ...
   **/
  public IndividualVO preferredGivenName(String preferredGivenName) {
   ...
   **/
  public IndividualVO title(String title) {
    this.title = title;
    return this;
  }
  ...
  /**
   **/
  public IndividualVO contactMedium(List<@Valid ContactMediumVO> contactMedium) {
  ...
  public IndividualVO removeContactMediumItem(ContactMediumVO contactMediumItem) {
  ...
  /**
   **/
  public IndividualVO creditRating(List<@Valid PartyCreditProfileVO> creditRating) {
  ...
  public IndividualVO removeCreditRatingItem(PartyCreditProfileVO creditRatingItem) {
  ...
  /**
   **/
  public IndividualVO disability(List<@Valid DisabilityVO> disability) {
  ...
  public IndividualVO removeDisabilityItem(DisabilityVO disabilityItem) {
  ...
  /**
   **/
  public IndividualVO externalReference(List<@Valid ExternalReferenceVO> externalReference) {
  ...
  public IndividualVO removeExternalReferenceItem(ExternalReferenceVO externalReferenceItem) {
  ...
  /**
   **/
  public IndividualVO individualIdentification(List<@Valid IndividualIdentificationVO> individualIdentification) {
  ...
  public IndividualVO removeIndividualIdentificationItem(IndividualIdentificationVO individualIdentificationItem) {
  ...
  /**
   **/
  public IndividualVO languageAbility(List<@Valid LanguageAbilityVO> languageAbility) {
  ...
  public IndividualVO removeLanguageAbilityItem(LanguageAbilityVO languageAbilityItem) {
  ...
  /**
   **/
  public IndividualVO otherName(List<@Valid OtherNameIndividualVO> otherName) {
  ...
  public IndividualVO removeOtherNameItem(OtherNameIndividualVO otherNameItem) {
  ...
  /**
   **/
  public IndividualVO partyCharacteristic(List<@Valid CharacteristicVO> partyCharacteristic) {
  ...
  public IndividualVO removePartyCharacteristicItem(CharacteristicVO partyCharacteristicItem) {
  ...
  /**
   **/
  public IndividualVO relatedParty(List<@Valid RelatedPartyVO> relatedParty) {
  ...
  public IndividualVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
  ...
  /**
   **/
  public IndividualVO skill(List<@Valid SkillVO> skill) {
    this.skill = skill;
    return this;
  }
  ...
  public IndividualVO removeSkillItem(SkillVO skillItem) {
  ...
  /**
   **/
  public IndividualVO status(IndividualStateTypeVO status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public IndividualVO taxExemptionCertificate(List<@Valid TaxExemptionCertificateVO> taxExemptionCertificate) {
  ...
  public IndividualVO removeTaxExemptionCertificateItem(TaxExemptionCertificateVO taxExemptionCertificateItem) {
   ...
   **/
  public IndividualVO atBaseType(String atBaseType) {
   ...
   **/
  public IndividualVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public IndividualVO atType(String atType) {
    this.atType = atType;
    return this;
  }
