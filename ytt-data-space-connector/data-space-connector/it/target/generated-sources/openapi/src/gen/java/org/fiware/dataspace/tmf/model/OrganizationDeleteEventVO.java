...
import org.fiware.dataspace.tmf.model.OrganizationDeleteEventPayloadVO;
...
@JsonTypeName("OrganizationDeleteEvent")
...
public class OrganizationDeleteEventVO   {
   ...
   **/
  public OrganizationDeleteEventVO eventId(String eventId) {
   ...
   **/
  public OrganizationDeleteEventVO eventTime(Date eventTime) {
   ...
   **/
  public OrganizationDeleteEventVO description(String description) {
   ...
   **/
  public OrganizationDeleteEventVO timeOcurred(Date timeOcurred) {
   ...
   **/
  public OrganizationDeleteEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public OrganizationDeleteEventVO eventType(String eventType) {
   ...
   **/
  public OrganizationDeleteEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * A priority.
   **/
  public OrganizationDeleteEventVO priority(String priority) {
   ...
   **/
  public OrganizationDeleteEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public OrganizationDeleteEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public OrganizationDeleteEventVO correlationId(String correlationId) {
  ...
  /**
   **/
  public OrganizationDeleteEventVO event(OrganizationDeleteEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public OrganizationDeleteEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(OrganizationDeleteEventPayloadVO event) {
    this.event = event;
  }
