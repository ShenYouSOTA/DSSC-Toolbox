...
public class MarketSegmentRefVO   {
   ...
   **/
  public MarketSegmentRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public MarketSegmentRefVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public MarketSegmentRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public MarketSegmentRefVO atBaseType(String atBaseType) {
   ...
   **/
  public MarketSegmentRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public MarketSegmentRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public MarketSegmentRefVO atReferredType(String atReferredType) {
