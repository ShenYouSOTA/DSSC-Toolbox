...
import org.fiware.dataspace.tmf.model.ProductBatchEventPayloadVO;
...
@JsonTypeName("ProductBatchEvent")
...
public class ProductBatchEventVO   {
   ...
   **/
  public ProductBatchEventVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public ProductBatchEventVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public ProductBatchEventVO eventId(String eventId) {
   ...
   **/
  public ProductBatchEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductBatchEventVO eventType(String eventType) {
   ...
   **/
  public ProductBatchEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductBatchEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductBatchEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductBatchEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductBatchEventVO priority(String priority) {
   ...
   **/
  public ProductBatchEventVO timeOcurred(Date timeOcurred) {
  ...
  /**
   **/
  public ProductBatchEventVO event(ProductBatchEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductBatchEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductBatchEventPayloadVO event) {
    this.event = event;
  }
