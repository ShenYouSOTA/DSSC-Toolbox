...
public class OrganizationCreateVO   {
   ...
   **/
  public OrganizationCreateVO isHeadOffice(Boolean isHeadOffice) {
   ...
   **/
  public OrganizationCreateVO isLegalEntity(Boolean isLegalEntity) {
   ...
   **/
  public OrganizationCreateVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public OrganizationCreateVO nameType(String nameType) {
   ...
   **/
  public OrganizationCreateVO organizationType(String organizationType) {
   ...
   **/
  public OrganizationCreateVO tradingName(String tradingName) {
  ...
  @NotNull public String getTradingName() {
    return tradingName;
  }
  ...
  /**
   **/
  public OrganizationCreateVO contactMedium(List<@Valid ContactMediumVO> contactMedium) {
  ...
  public OrganizationCreateVO removeContactMediumItem(ContactMediumVO contactMediumItem) {
  ...
  /**
   **/
  public OrganizationCreateVO creditRating(List<@Valid PartyCreditProfileVO> creditRating) {
  ...
  public OrganizationCreateVO removeCreditRatingItem(PartyCreditProfileVO creditRatingItem) {
  ...
  /**
   **/
  public OrganizationCreateVO existsDuring(TimePeriodVO existsDuring) {
  ...
  /**
   **/
  public OrganizationCreateVO externalReference(List<@Valid ExternalReferenceVO> externalReference) {
  ...
  public OrganizationCreateVO removeExternalReferenceItem(ExternalReferenceVO externalReferenceItem) {
  ...
  /**
   **/
  public OrganizationCreateVO organizationChildRelationship(List<@Valid OrganizationChildRelationshipVO> organizationChildRelationship) {
  ...
  public OrganizationCreateVO removeOrganizationChildRelationshipItem(OrganizationChildRelationshipVO organizationChildRelationshipItem) {
  ...
  /**
   **/
  public OrganizationCreateVO organizationIdentification(List<@Valid OrganizationIdentificationVO> organizationIdentification) {
  ...
  public OrganizationCreateVO removeOrganizationIdentificationItem(OrganizationIdentificationVO organizationIdentificationItem) {
  ...
  /**
   **/
  public OrganizationCreateVO organizationParentRelationship(OrganizationParentRelationshipVO organizationParentRelationship) {
  ...
  /**
   **/
  public OrganizationCreateVO otherName(List<@Valid OtherNameOrganizationVO> otherName) {
  ...
  public OrganizationCreateVO removeOtherNameItem(OtherNameOrganizationVO otherNameItem) {
  ...
  /**
   **/
  public OrganizationCreateVO partyCharacteristic(List<@Valid CharacteristicVO> partyCharacteristic) {
  ...
  public OrganizationCreateVO removePartyCharacteristicItem(CharacteristicVO partyCharacteristicItem) {
  ...
  /**
   **/
  public OrganizationCreateVO relatedParty(List<@Valid RelatedPartyVO> relatedParty) {
  ...
  public OrganizationCreateVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
  ...
  /**
   **/
  public OrganizationCreateVO status(OrganizationStateTypeVO status) {
    this.status = status;
    return this;
  }
  ...
  /**
   **/
  public OrganizationCreateVO taxExemptionCertificate(List<@Valid TaxExemptionCertificateVO> taxExemptionCertificate) {
  ...
  public OrganizationCreateVO removeTaxExemptionCertificateItem(TaxExemptionCertificateVO taxExemptionCertificateItem) {
   ...
   **/
  public OrganizationCreateVO atBaseType(String atBaseType) {
   ...
   **/
  public OrganizationCreateVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public OrganizationCreateVO atType(String atType) {
    this.atType = atType;
    return this;
  }
