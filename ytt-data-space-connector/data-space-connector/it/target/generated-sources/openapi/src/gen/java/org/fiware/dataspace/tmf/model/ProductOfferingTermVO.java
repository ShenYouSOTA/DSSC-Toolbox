...
public class ProductOfferingTermVO   {
   ...
   **/
  public ProductOfferingTermVO description(String description) {
   ...
   **/
  public ProductOfferingTermVO name(String name) {
    this.name = name;
    return this;
  }
  ...
  /**
   **/
  public ProductOfferingTermVO duration(DurationVO duration) {
  ...
  @Valid public DurationVO getDuration() {
    return duration;
  }
  ...
  /**
   **/
  public ProductOfferingTermVO validFor(TimePeriodVO validFor) {
   ...
   **/
  public ProductOfferingTermVO atBaseType(String atBaseType) {
   ...
   **/
  public ProductOfferingTermVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ProductOfferingTermVO atType(String atType) {
    this.atType = atType;
    return this;
  }
