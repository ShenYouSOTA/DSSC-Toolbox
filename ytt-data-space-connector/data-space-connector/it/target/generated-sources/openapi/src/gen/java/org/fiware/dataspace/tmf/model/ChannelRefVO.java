...
public class ChannelRefVO   {
   ...
   * unique identifier
   **/
  public ChannelRefVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   * Hyperlink reference
   **/
  public ChannelRefVO href(URI href) {
    this.href = href;
    return this;
  }
   ...
   * Name of the channel.
   **/
  public ChannelRefVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ChannelRefVO atBaseType(String atBaseType) {
   ...
   **/
  public ChannelRefVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ChannelRefVO atType(String atType) {
    this.atType = atType;
    return this;
  }
   ...
   **/
  public ChannelRefVO atReferredType(String atReferredType) {
