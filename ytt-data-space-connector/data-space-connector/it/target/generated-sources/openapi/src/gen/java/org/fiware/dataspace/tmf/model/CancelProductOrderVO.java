...
@JsonTypeName("CancelProductOrder")
...
public class CancelProductOrderVO   {
   ...
   **/
  public CancelProductOrderVO id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public CancelProductOrderVO href(String href) {
    this.href = href;
    return this;
  }
   ...
   **/
  public CancelProductOrderVO cancellationReason(String cancellationReason) {
   ...
   **/
  public CancelProductOrderVO effectiveCancellationDate(Date effectiveCancellationDate) {
   ...
   **/
  public CancelProductOrderVO requestedCancellationDate(Date requestedCancellationDate) {
  ...
  /**
   **/
  public CancelProductOrderVO productOrder(ProductOrderRefVO productOrder) {
  ...
  /**
   **/
  public CancelProductOrderVO state(TaskStateTypeVO state) {
    this.state = state;
    return this;
  }
   ...
   **/
  public CancelProductOrderVO atBaseType(String atBaseType) {
   ...
   **/
  public CancelProductOrderVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public CancelProductOrderVO atType(String atType) {
    this.atType = atType;
    return this;
  }
