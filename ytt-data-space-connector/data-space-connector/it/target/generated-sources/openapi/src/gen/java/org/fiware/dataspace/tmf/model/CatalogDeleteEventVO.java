...
import org.fiware.dataspace.tmf.model.CatalogDeleteEventPayloadVO;
...
public class CatalogDeleteEventVO   {
  ...
  /**
   **/
  public CatalogDeleteEventVO event(CatalogDeleteEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public CatalogDeleteEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(CatalogDeleteEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public CatalogDeleteEventVO eventId(String eventId) {
   ...
   **/
  public CatalogDeleteEventVO eventTime(Date eventTime) {
   ...
   **/
  public CatalogDeleteEventVO eventType(String eventType) {
   ...
   **/
  public CatalogDeleteEventVO correlationId(String correlationId) {
   ...
   **/
  public CatalogDeleteEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public CatalogDeleteEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public CatalogDeleteEventVO description(String description) {
   ...
   * A priority.
   **/
  public CatalogDeleteEventVO priority(String priority) {
   ...
   **/
  public CatalogDeleteEventVO timeOcurred(Date timeOcurred) {
