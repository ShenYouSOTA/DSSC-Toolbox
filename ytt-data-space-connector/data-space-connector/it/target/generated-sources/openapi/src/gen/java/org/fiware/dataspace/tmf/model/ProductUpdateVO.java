...
public class ProductUpdateVO   {
   ...
   **/
  public ProductUpdateVO description(String description) {
   ...
   **/
  public ProductUpdateVO isBundle(Boolean isBundle) {
   ...
   **/
  public ProductUpdateVO isCustomerVisible(Boolean isCustomerVisible) {
   ...
   **/
  public ProductUpdateVO name(String name) {
    this.name = name;
    return this;
  }
   ...
   **/
  public ProductUpdateVO orderDate(Date orderDate) {
   ...
   **/
  public ProductUpdateVO productSerialNumber(String productSerialNumber) {
   ...
   **/
  public ProductUpdateVO startDate(Date startDate) {
   ...
   **/
  public ProductUpdateVO terminationDate(Date terminationDate) {
  ...
  /**
   **/
  public ProductUpdateVO agreement(List<@Valid AgreementItemRefVO> agreement) {
  ...
  public ProductUpdateVO removeAgreementItem(AgreementItemRefVO agreementItem) {
  ...
  /**
   **/
  public ProductUpdateVO billingAccount(BillingAccountRefVO billingAccount) {
  ...
  /**
   **/
  public ProductUpdateVO place(List<@Valid RelatedPlaceRefOrValueVO> place) {
    this.place = place;
    return this;
  }
  ...
  public ProductUpdateVO removePlaceItem(RelatedPlaceRefOrValueVO placeItem) {
  ...
  /**
   **/
  public ProductUpdateVO product(List<@Valid ProductRefOrValueVO> product) {
  ...
  public ProductUpdateVO removeProductItem(ProductRefOrValueVO productItem) {
  ...
  /**
   **/
  public ProductUpdateVO productCharacteristic(List<@Valid CharacteristicVO> productCharacteristic) {
  ...
  public ProductUpdateVO removeProductCharacteristicItem(CharacteristicVO productCharacteristicItem) {
  ...
  /**
   **/
  public ProductUpdateVO productOffering(ProductOfferingRefVO productOffering) {
  ...
  /**
   **/
  public ProductUpdateVO productOrderItem(List<@Valid RelatedProductOrderItemVO> productOrderItem) {
  ...
  public ProductUpdateVO removeProductOrderItemItem(RelatedProductOrderItemVO productOrderItemItem) {
  ...
  /**
   **/
  public ProductUpdateVO productPrice(List<@Valid ProductPriceVO> productPrice) {
  ...
  public ProductUpdateVO removeProductPriceItem(ProductPriceVO productPriceItem) {
  ...
  /**
   **/
  public ProductUpdateVO productRelationship(List<@Valid ProductRelationshipVO> productRelationship) {
  ...
  public ProductUpdateVO removeProductRelationshipItem(ProductRelationshipVO productRelationshipItem) {
  ...
  /**
   **/
  public ProductUpdateVO productSpecification(ProductSpecificationRefVO productSpecification) {
  ...
  /**
   **/
  public ProductUpdateVO productTerm(List<@Valid ProductTermVO> productTerm) {
  ...
  public ProductUpdateVO removeProductTermItem(ProductTermVO productTermItem) {
  ...
  /**
   **/
  public ProductUpdateVO realizingResource(List<@Valid ResourceRefVO> realizingResource) {
  ...
  public ProductUpdateVO removeRealizingResourceItem(ResourceRefVO realizingResourceItem) {
  ...
  /**
   **/
  public ProductUpdateVO realizingService(List<@Valid ServiceRefVO> realizingService) {
  ...
  public ProductUpdateVO removeRealizingServiceItem(ServiceRefVO realizingServiceItem) {
  ...
  /**
   **/
  public ProductUpdateVO relatedParty(List<@Valid RelatedPartyVO> relatedParty) {
  ...
  public ProductUpdateVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
  ...
  /**
   **/
  public ProductUpdateVO status(ProductStatusTypeVO status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public ProductUpdateVO atBaseType(String atBaseType) {
   ...
   **/
  public ProductUpdateVO atSchemaLocation(URI atSchemaLocation) {
   ...
   **/
  public ProductUpdateVO atType(String atType) {
    this.atType = atType;
    return this;
  }
