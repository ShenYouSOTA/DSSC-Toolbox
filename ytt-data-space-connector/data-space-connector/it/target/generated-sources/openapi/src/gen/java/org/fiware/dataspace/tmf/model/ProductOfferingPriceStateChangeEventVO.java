...
import org.fiware.dataspace.tmf.model.ProductOfferingPriceStateChangeEventPayloadVO;
...
public class ProductOfferingPriceStateChangeEventVO   {
  ...
  /**
   **/
  public ProductOfferingPriceStateChangeEventVO event(ProductOfferingPriceStateChangeEventPayloadVO event) {
    this.event = event;
    return this;
  }
  ...
  @JsonProperty("event")
  @Valid public ProductOfferingPriceStateChangeEventPayloadVO getEvent() {
    return event;
  }

  @JsonProperty("event")
  public void setEvent(ProductOfferingPriceStateChangeEventPayloadVO event) {
    this.event = event;
  }
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO eventId(String eventId) {
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO eventTime(Date eventTime) {
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO eventType(String eventType) {
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO correlationId(String correlationId) {
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO title(String title) {
    this.title = title;
    return this;
  }
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO description(String description) {
   ...
   * A priority.
   **/
  public ProductOfferingPriceStateChangeEventVO priority(String priority) {
   ...
   **/
  public ProductOfferingPriceStateChangeEventVO timeOcurred(Date timeOcurred) {
